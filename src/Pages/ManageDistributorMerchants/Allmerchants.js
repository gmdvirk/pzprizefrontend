import { CiCircleFilled,MoreOutlined, CloseCircleFilled, CreditCardFilled, DeleteFilled, DollarCircleFilled, EditFilled, InfoCircleFilled, LockFilled, LoginOutlined, MinusCircleFilled, PlusCircleFilled, SaveFilled, SearchOutlined, ArrowDownOutlined } from '@ant-design/icons';
  ...
  return (
    ...
    {loading ? (
      ...
      >
       ...
       {creditopen&& <Creditmanager products={products} setProducts={setProducts}   selectedProduct={selectedProduct} setSelectedProduct={setSelectedProduct} payment={payment} setPayment={setPayment}/>}
   {cashopen&& <Cashmanager products={products} setProducts={setProducts}  selectedProduct={selectedProduct} setSelectedProduct={setSelectedProduct} payment={payment} setPayment={setPayment} />}
